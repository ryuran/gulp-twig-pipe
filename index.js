...
function gulpTwigPipe(templateSrc, options) {
    ...
    var compile = options.compile || Twig.twig;
...
gulpTwigPipe.extend = function(extension) {
    Twig.extend(extension);
};

gulpTwigPipe.twig = Twig;

// Exporting the plugin main function
module.exports = gulpTwigPipe;
